...
export const Skill = () => {
  return (
    <div className="bg-skill bg-100% px-10 pb-10 md:-mt-20">
      <div className='pt-10 md:flex justify-center text-center md:pt-32 md:px-64 md:pb-32'>
        <Image src='/skill.png' width={1800} height={700} alt="スキル画像"/>
